...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "salvatorahishakiye@gmail.com", path: 'mailto:salvatorahishakiye@gmail.com', icon: MailIcon },
                { text: "+250 791 112 656", path: 'https://wa.me/250791112656', icon: PhoneIcon },
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to Ruvumera Market, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © Ruvumera Market All Right Reserved.
                </p>
            </div>
        </footer>
    );
